...
export function generateCloudflareHeaders(existing: string = ""): string {
...
export async function writeCloudflareHeaders(projectDir: string): Promise<void> {
  ...
  const content = generateCloudflareHeaders(existing);
